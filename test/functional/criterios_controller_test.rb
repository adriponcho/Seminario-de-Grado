...
class CriteriosControllerTest < ActionController::TestCase
  ...
  test "should create criterio" do
    assert_difference('Criterio.count') do
      post :create, criterio: { descripcion: @criterio.descripcion, estado: @criterio.estado, nombre: @criterio.nombre, tipo: @criterio.tipo }
    end
  ...
  test "should update criterio" do
    put :update, id: @criterio, criterio: { descripcion: @criterio.descripcion, estado: @criterio.estado, nombre: @criterio.nombre, tipo: @criterio.tipo }
    assert_redirected_to criterio_path(assigns(:criterio))
  end
